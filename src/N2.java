...
public class N2 {
    public void n2() {
        ...
        int number_of_apartment = in.nextInt();
        ...
        String type_of_building = in.next();
        System.out.println("Введите срок эксплуатации: ");
        int life_of_building = in.nextInt();

        House house = new House(id, number_of_apartment, area, floor, number_of_rooms, street, type_of_building, life_of_building);
